...
<p align="center">
  ...
  <img alt="版本" src="https://img.shields.io/badge/version-0.2.4-22c55e?style=flat-square">
...
| `后端模式` | 支持本地模式和远程后端模式 |
| `菜单栏快览` | 点击菜单栏图标即可查看所有服务额度、费用和活跃账号 — 迷你进度环 + 一键切换账号 |
| `主题模式` | 支持跟随系统、浅色、深色三种外观 |
| `开机启动` | 可选登录后自动启动 AIUsage |
| `自动更新` | 集成 Sparkle 框架，后台自动下载并静默安装新版本，支持中英文更新提示 |
